...
<?php
	...
	function displayPropertyInfo($image_filename, $find_city)
	{
		...
		$imagename = '/sandbox/images/'.$image_filename;     // .jpg file
		// echo "$imagename - imagename var";
		...
		$filename = 'd:/git/practice-php/sandbox/houses_indexed/'.$index_filename;   // .txt file
		// nije mi radilo dokle nisam dao apsolutnu putanju
		$fp = fopen($filename, 'r');
